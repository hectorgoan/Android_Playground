...
//Adaptador de ListView universal, para listas no actualizables mientras el usuario las consulta
public abstract class Lista_adaptador extends BaseAdapter
{
    ...
    /**
     *Devuelve cada una de las entradas con cada una de las vistas a las que debe de ser asociada
